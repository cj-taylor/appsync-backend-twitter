...
describe("Given an authenticated user retweeted another users' tweet", () => {
  ...
  describe("When userA unretweets userB's tweet", () => {
    ...
    it("Removes the retweet in the Tweets table", async () => {
    ...
    it("Removes the retweet in the Retweets table", async () => {
